...
The architecture is divided into three main layers: **HTTP Transport**, **Media Type**, and **Resource Type**. Each layer defines specific aspects of the protocol, including transport mechanisms, data representation, and resource definitions. This layered approach allows for clear separation of concerns, enabling independent evolution and extensibility of each layer.

image::Architecture.drawio.svg[Static,300]
