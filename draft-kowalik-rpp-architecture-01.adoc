...
*  **'vc' Structure Adaptation:**  Reusing Verifiable Credentials
data structures, especially for representing identity or authorization information, allowing for integration with external identity systems.
...
* Removed requirements and replaced with a reference to RPP WG Wiki
